...
@Directive({
    selector: '[appBgStateSolidColor]'
})
export class BgStateSolidColorDirective implements OnInit {
    @Input('appBgStateSolidColor') appBgStateColor: { color1: string, color2: string };
